...
ggpairs(Boston[,0:7])
ggpairs(Boston[,8:14])
ggpairs(Boston, mapping = aes(alpha = 0.1),lower = list(combo = wrap("facethist", bins = 20)))
```


Variables dis and nox have the highest correlation in absolute value (-0,769). On the other hand variables nox and indus have the highest positive correlation (0,764). Distributions of variables crim, zn and chas are clearly skewed towards left. Rm has quite normal distribution. Variables age and black have the distuributions that are skewed the most towards right.
